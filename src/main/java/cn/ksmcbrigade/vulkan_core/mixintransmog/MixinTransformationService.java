...
public class MixinTransformationService implements ITransformationService {
    ...
    private static void replaceMixinLaunchPlugin() {
        try {
            ...
            Map<String, ILaunchPluginService> plugins = getStringILaunchPluginServiceMap();
    ...
    private static Map<String, ILaunchPluginService> getStringILaunchPluginServiceMap() throws NoSuchFieldException, IllegalAccessException {
